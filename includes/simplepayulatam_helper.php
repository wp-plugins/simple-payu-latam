...
class sp_spl_LiveUpdatePayU {
    ...
    var $automode = false;
		 ...
		 * @return		void
		 */
		function LiveUpdateModPayU ($secretKey = '', $liveUpdateURL = 'https://secure.epayment.ro/order/lu.php', $debugMode = false, $testMode = false, $language = 'ro') {
